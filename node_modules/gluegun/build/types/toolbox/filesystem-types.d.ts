...
export interface GluegunFilesystem {
     ...
     * Returns details about a filesystem object found at a path.
     */
    inspectAsync(path: string, options?: GluegunFileSystemInspectOptions): Promise<GluegunFileSystemInspectResult[] | void>;
    /**
     ...
     * Returns details about a filesystem tree found at the path.
     */
    inspectTreeAsync(path: string, options?: GluegunFileSystemInspectTreeOptions): Promise<GluegunFileSystemInspectTreeResult | void>;
    /**
 ...
 */
export declare type GluegunFilesystemCopyResolveHandler = (srcData: any, destData: any) => boolean;
...
export declare type GluegunFilesystemReadType = 'utf8'
/** A Node Buffer */
 | 'buffer'
