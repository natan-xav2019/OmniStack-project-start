...
test('can create a new boilerplate cli', function () { return __awaiter(_this, void 0, void 0, function () {
    var tmp, toolbox, pkg, testResults, runCommand, cleanCmd, genCommand, genFile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, toolbox.system.run("cd " + tmp + "/foo && yarn add " + pwd)
                    // Run the tests
                ];
            case 2:
                // Install local version of gluegun to test
                _a.sent();
                return [4 /*yield*/, toolbox.system.run("cd " + tmp + "/foo && yarn test")];
            case 3:
                testResults = _a.sent();
                expect(testResults).toContain('jest');
                return [4 /*yield*/, toolbox.system.run("node " + tmp + "/foo/bin/foo --help")];
            case 4:
                runCommand = _a.sent();
                ...
                return [4 /*yield*/, toolbox.system.run("node " + tmp + "/foo/bin/foo g flub")];
            case 5:
                genCommand = _a.sent();
                console.log(genCommand);
                genFile = toolbox.filesystem.read(tmp + "/models/flub-model.js");
...
test('can create a new boilerplate TypeScript cli', function () { return __awaiter(_this, void 0, void 0, function () {
    var tmp, toolbox, pkg, testResults, runCommand, cleanCmd, genCommand, genFile, generateResult, kitchenCommand;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tmp = uniqueTempDir({ create: true });
            ...
            case 1:
                ...
                expect(Object.keys(pkg.dependencies).includes('gluegun')).toBeTruthy();
                // Install local version of gluegun to test
                return [4 /*yield*/, toolbox.system.run("cd " + tmp + "/foo-ts && yarn add " + pwd)
                    // Run the tests
                ];
            case 2:
                // Install local version of gluegun to test
                _a.sent();
                return [4 /*yield*/, toolbox.system.run("cd " + tmp + "/foo-ts && yarn test")];
            case 3:
                testResults = _a.sent();
                expect(testResults).toContain('jest');
                return [4 /*yield*/, toolbox.system.run("node " + tmp + "/foo-ts/bin/foo-ts --help")];
            case 4:
                runCommand = _a.sent();
                cleanCmd = stripANSI(runCommand);
                expect(cleanCmd).toMatch(/version \(v\)/);
                ...
                expect(cleanCmd).toMatch(/generate \(g\)/);
                expect(cleanCmd).toMatch(/help \(h\)/);
                return [4 /*yield*/, toolbox.system.run("node " + tmp + "/foo-ts/bin/foo-ts g flub")];
            case 5:
                genCommand = _a.sent();
                console.log(genCommand);
                genFile = toolbox.filesystem.read(tmp + "/models/flub-model.ts");
                expect(genFile).toMatch(/name\: \'flub\'/);
            ...
            case 6:
                ...
                return [4 /*yield*/, toolbox.system.run("node " + tmp + "/foo-ts/bin/foo-ts kitchen")];
            case 7:
